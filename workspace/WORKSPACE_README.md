...
A local web app is now available in `../webapp` with:

- Dashboard for generated/approved/rejected designs
- Design browser + manual approve/reject actions
- Generation triggers (single/batch, sneaker/general)
- Job queue history
- Expense tracker CRUD (reads/writes `financials.xlsx`)

### Run backend (Python 3.13 recommended)
